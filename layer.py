...
class SqueezeExcitation(nn.Module):
    def __init__(self,channels,squeeze_channels=None):
        ...
        self.excitation1 = nn.Conv2d(channels, squeeze_channels, kernel_size=1)
        self.excitation2 = nn.Conv2d(squeeze_channels, channels, kernel_size=1)
    ...
    def forward(self,x):
        ...
        #print(fm_size1)
        #print(fm_size2)
        scale_weight = F.avg_pool2d(x,(fm_size1,fm_size2))
...
class Conv2d(nn.Module):
    def __init__(self, nch_in, nch_out, kernel_size=4, stride=1, padding=1, bias=True):
        ...
        self.conv = nn.Conv2d(nch_in, nch_out, kernel_size=kernel_size, stride=stride, padding=padding, bias=bias, padding_mode= 'reflect')
