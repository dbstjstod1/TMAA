...
## 라이브러리 추가하기
    ...
    parser.add_argument("--ckpt_dir", default="./ablation/checkpoint3_nores", type=str, dest="ckpt_dir")
    
    parser.add_argument("--log_dir", default="./ablation/log3_nores", type=str, dest="log_dir")
    parser.add_argument("--result_dir", default="./ablation/result3_nores", type=str, dest="result_dir")
    ...
    if mode == 'train':
        ...
        for epoch in range(st_epoch + 1, num_epoch + 1):
            ...
            for batch, data in enumerate(loader_train, 1):
                ...
                output = net(input,input2)
    
                # backward pass
                optim.zero_grad()
    
                loss = 0.01*fn_loss(output, label) + fn_loss2(output,label)
                loss.backward()
    ...
    # TEST MODE
        ...
        with torch.no_grad():
            ...
            for batch, data in enumerate(loader_test, 1):
                ...
                # 손실함수 계산하기
                loss = fn_loss2(output/1000, label/1000)
