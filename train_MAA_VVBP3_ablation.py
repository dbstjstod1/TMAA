...
## 라이브러리 추가하기
    ...
    parser.add_argument("--ckpt_dir", default="./checkpoint3_mse", type=str, dest="ckpt_dir")
    
    parser.add_argument("--log_dir", default="./log3_mse", type=str, dest="log_dir")
    parser.add_argument("--result_dir", default="./result3_mse", type=str, dest="result_dir")
